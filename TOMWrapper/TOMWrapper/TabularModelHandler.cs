...
namespace TabularEditor.TOMWrapper
{
    ...
    public sealed partial class TabularModelHandler : IDisposable
    {
        ...
        public TabularModelHandler(string serverName, string databaseName, string userName, string password, TabularModelHandlerSettings settings = null): this(settings)
        {
            ...
            var connectionString = TabularConnection.GetConnectionString(serverName,  userName, password, databaseName);
